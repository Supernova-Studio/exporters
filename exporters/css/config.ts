...
export type ExporterConfiguration = {
  ...
  /** Name of each css file that will be generated. Tokens are grouped by the type and will land in each of those files */
  styleFileNames: Record<TokenType, string>;
  /** Name of the index css file that will be generated */
  styleFileName: string;
  /** Name of each js file that will be generated. Tokens are grouped by the type and will land in each of those files */
  typeScriptFileNames: Record<TokenType, string>;
  /** Name of the index js file that will be generated */
  typeScriptFileName: string;
  /** All css files will be written to this directory (relative to export root set by the exporter / pipeline configuration / VSCode extension) */
  baseStyleFilePath: string;
  /** All ts files will be written to this directory (relative to export root set by the exporter / pipeline configuration / VSCode extension) */
  baseTypeScriptFilePath: string;
