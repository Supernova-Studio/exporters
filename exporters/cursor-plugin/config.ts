...
export type ExporterConfiguration = {
  /** Cursor plugin identifier. Empty means a slug of the context name is used at export time. */
  pluginName: string
  /** Version written to .cursor-plugin/plugin.json. */
  ...
  /** Optional author URL used as a homepage fallback when pluginHomepage is empty. */
