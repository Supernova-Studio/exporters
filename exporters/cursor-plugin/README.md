...
- `.cursor-plugin/marketplace.json` and `README.md` for publishing and installing from a repository (enabled by default).
...
- **pluginVersion:** Version written to `.cursor-plugin/plugin.json`. Defaults to `1.0.0`.
