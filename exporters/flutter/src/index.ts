...
import { keyOutputFile } from './files/key-file'

// TODO: Cleanup, types, config, default file names, extract to export-helpers, wrap defaults functions from this file (like to jusdt inject index + styles files) into export-helpers
...
Pulsar.export(async (sdk: Supernova, context: PulsarContext): Promise<Array<AnyOutputFile>> => {
  ...
  return [
    ...
    ...(Object.values(TokenType)
      .flatMap((type) => [styleOutputFile(type, tokens, tokenGroups), keyOutputFile(type, tokens, tokenGroups)])
