...
/**
 * Main export function that generates Jetpack Compose files from design tokens
 *
...
Pulsar.export(async (sdk: Supernova, context: PulsarContext): Promise<Array<AnyOutputFile>> => {
    ...
    if (!context.isPreview && exportConfiguration.writeNameToProperty) {
        ...
        if (exportConfiguration.writeNameToProperty) {
            await writeStore.writeTokenProperties(exportConfiguration.propertyToWriteNameTo, allowedTokens, (token) => {
